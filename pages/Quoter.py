...
st.markdown("[Contribute](https://forms.gle/H6aVkxk1ntaRAiRX7) to the log! Allow several minutes to update")

url = "https://docs.google.com/spreadsheets/d/1z49yYw1XBOccYkBhr0ZHTdY-YDqOBZMh7ci2bJTh7fI/edit?usp=sharing"
conn = st.experimental_connection("gsheets", type=GSheetsConnection)
# https://docs.google.com/spreadsheets/d/1z49yYw1XBOccYkBhr0ZHTdY-YDqOBZMh7ci2bJTh7fI/edit?usp=sharing
